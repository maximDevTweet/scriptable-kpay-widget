module.exports.KpayMerchantApiData = (loadFromFile, storeInFile) => {
  return new KpayMerchantApiData(loadFromFile, storeInFile);
}

class KpayMerchantApiData {
  ...
  setMaximumAge(maximumAge) {
    if (maximumAge < 0) {
      maximumAge = 0;    //no less then 15 minutes!
    }
